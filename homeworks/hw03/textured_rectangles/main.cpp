...
int main(void)
{
    ...
    window = glfwCreateWindow(width, height, "Textured Rectangles", NULL, NULL);
    if (!window)
    {
    ...
    float vertices[] = {
        ...
        -0.2f, -0.3f, 0.0f,   0.0f, 0.0f, // Bottom Left
         0.2f, -0.3f, 0.0f,   1.0f, 0.0f, // Bottom Right
         0.2f,  0.3f, 0.0f,   1.0f, 1.0f  // Top Right
    };
    ...
    // Load three distinct textures
    unsigned int tex1 = loadTexture("res/textures/0.jpeg");
    unsigned int tex2 = loadTexture("res/textures/1.jpeg");
    unsigned int tex3 = loadTexture("res/textures/2.jpeg");
    ...
    while (!glfwWindowShouldClose(window) && glfwGetKey(window, GLFW_KEY_ESCAPE) != GLFW_PRESS)
    {
        ...
        // 1. Left rectangle
        glm::mat4 transform1 = glm::translate(glm::mat4(1.0f), glm::vec3(-0.6f, 0.0f, 0.0f));
        ...
        // 3. Right rectangle
        glm::mat4 transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(0.6f, 0.0f, 0.0f));
        glUniformMatrix4fv(transform_loc, 1, GL_FALSE, glm::value_ptr(transform3));
        glActiveTexture(GL_TEXTURE0);
